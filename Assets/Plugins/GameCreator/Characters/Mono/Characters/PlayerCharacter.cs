namespace GameCreator.Characters
{
    ...
    public class PlayerCharacter : Character
    {
        ...
        protected virtual void Update()
        {
            ...
            {
                if (ControlFreak2.CF2Input.GetKeyDown(this.jumpKey)) this.Jump();
            }
            else
            {
        ...
        protected virtual void UpdateInputDirectional()
        {
            ...
            else
            {
                targetDirection = new Vector3(
                    ControlFreak2.CF2Input.GetAxisRaw(AXIS_H),
                    0.0f,
                    ControlFreak2.CF2Input.GetAxisRaw(AXIS_V)
                );
            }
        ...
        protected virtual void UpdateInputTank()
        {
            ...
            else
            {
                ...
                rotationY = ControlFreak2.CF2Input.GetAxis(AXIS_H);
            }
        ...
        protected virtual void UpdateInputPointClick()
        {
            ...
            if (ControlFreak2.CF2Input.GetMouseButtonDown((int)this.mouseButtonMove) && !this.uiConstrained)
            {
                Camera maincam = this.GetMainCamera();
                if (maincam == null) return;

                Ray cameraRay = maincam.ScreenPointToRay(ControlFreak2.CF2Input.mousePosition);
        ...
        protected virtual void UpdateInputFollowPointer()
        {
            ...
            if (ControlFreak2.CF2Input.GetMouseButton((int)this.mouseButtonMove) && !this.uiConstrained)
            {
        ...
        protected virtual void UpdateInputSideScroll(Vector3 axis)
        {
            ...
            {
                targetDirection = axis * ControlFreak2.CF2Input.GetAxis(AXIS_H);
            }
        ...
        protected void UpdateUIConstraints()
        {
            ...
            {
                if (ControlFreak2.CF2Input.GetTouch(i).phase != TouchPhase.Began) continue;

                int fingerID = ControlFreak2.CF2Input.GetTouch(i).fingerId;
