    ...
    public class CameraMotorTypeAdventure : ICameraMotorType
    {
        ...
        public override void UpdateMotor()
        {
            ...
            if (this.allowZoom)
            {
                this.desiredZoom = Mathf.Clamp(
                    this.desiredZoom - ControlFreak2.CF2Input.GetAxis(INPUT_MOUSE_W) * this.zoomSensitivity,
        ...
        private void RotationInput(ref float rotationX, ref float rotationY)
        {
            ...
            else
            {
                ...
                else if (this.orbitInput == OrbitInput.HoldLeftMouse && ControlFreak2.CF2Input.GetMouseButton(0)) inputConditions = true;
                else if (this.orbitInput == OrbitInput.HoldRightMouse && ControlFreak2.CF2Input.GetMouseButton(1)) inputConditions = true;
                else if (this.orbitInput == OrbitInput.HoldMiddleMouse && ControlFreak2.CF2Input.GetMouseButton(2)) inputConditions = true;
