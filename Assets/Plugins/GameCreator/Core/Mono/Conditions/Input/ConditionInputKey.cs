namespace GameCreator.Core
{
	...
	public class ConditionInputKey : ICondition
	{
		...
		public override bool Check()
		{
			...
			switch (this.state)
			{
			case STATE.BeingPressed : result = ControlFreak2.CF2Input.GetKey(this.key); break;
			case STATE.JustPressed  : result = ControlFreak2.CF2Input.GetKeyDown(this.key); break;
			case STATE.JustReleased : result = ControlFreak2.CF2Input.GetKeyUp(this.key); break;
			}
