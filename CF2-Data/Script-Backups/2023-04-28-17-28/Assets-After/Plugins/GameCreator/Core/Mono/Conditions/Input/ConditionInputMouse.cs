namespace GameCreator.Core
{
	...
	public class ConditionInputMouse : ICondition
	{
		...
		public override bool Check()
		{
			...
			switch (this.state)
			{
			case STATE.BeingPressed : result = ControlFreak2.CF2Input.GetMouseButton((int)this.button); break;
			case STATE.JustPressed  : result = ControlFreak2.CF2Input.GetMouseButtonDown((int)this.button); break;
			case STATE.JustReleased : result = ControlFreak2.CF2Input.GetMouseButtonUp((int)this.button); break;
			}
